...
function App() {
  ...
  return (
    <>
      <userdate.Provider value={{playerData,setFacilitylist, facilitylist,pricingRule,setPricingRule,pricingCost,setPricingCost}}>
