export const Facilitytype =["Tennis court","Football field","Racquetball court","BasketBall Court","BasketBall field","Soccer field","Ping pong table","Ice Hockey rink","Swimming Pool","Yoga Room","Pickleball court"];
export const Facilities=["All Court"]
export const BookingType=["Player","Tournament","Maintenance","Coach","Admin"];
export const FrequencyWeeks=["Weekly"];
...
export const days=['Mon','tus','wes',"thu",'fri','sat',"sun"];